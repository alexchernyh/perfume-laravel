                        ...
                        <select class="form-control" name="partner_categories_id">
                          @foreach ($cat_list as $item)
                            ...
                            @if($partner['partner_categories_id'] == $item['id'])
                              <option value="{{$item['id']}}" selected>{{ $item['category_name'] }} - {{ formatSum($item['project1_discount']) }}%/{{ formatSum($item['project2_discount']) }}%</option>
                            @else
                              <option value="{{$item['id']}}">{{ $item['category_name'] }} - {{ formatSum($item['project1_discount']) }}%/{{ formatSum($item['project2_discount']) }}%</option>
                            @endif

                                ...
                                @foreach ($cat_list as $item)
                                    @if($partner['partner_categories_id'] == $item['id'])
                                      ...
                                      <small class="text-muted d-block">
                                        perfumetinctures.com - {{ number_format($item['project1_discount'],0,"","") }}%
                                      </small>
                                      <small class="text-muted d-block">
                                        bionikks.ru - {{ number_format($item['project2_discount'],0,"","") }}%
                                      </small>
                                    @endif
                                @endforeach
                            </td>
    ...
    function renderPartnersList(list) {
      ...
      if(list.length > 0) {
        list.forEach(function(currentValue, index, arr) {
          ...
          html+='@csrf';
          html+='@method("DELETE")';
          html+="<button class='btn btn-danger btn-sm js-delete-btn'><i class='fas fa-trash'></i></button></form>";
          html+="</td>";
          html+="</tr>";
        })
      } else {
